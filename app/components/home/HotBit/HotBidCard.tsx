    ...
    <Tilt>
      <div className=" rounded-lg border-2 cursor-pointer border-gray-300 border-opacity-30 p-6">
        ...
        <div>
          ...
          <p className="mt-2 mb-2 text-lg text-gray-700">
            Price : <span className="text-yellow-500"> {data.currentBid}</span>
          </p>
          <div className="flex items-center mt-4 justify-between">
            <h1 className="text-indigo-900 text-sm font-bold">Place bid</h1>
